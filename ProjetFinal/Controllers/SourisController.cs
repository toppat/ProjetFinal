...
namespace ProjetFinal.Controllers
{
    public class SourisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TypeCatego,Prix,Nom,Description")] Souris souris)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TypeCatego,Prix,Nom,Description")] Souris souris)
        {
            if (ModelState.IsValid)
            {
